...
if __name__=='__main__':
    ...
    if mode:
        ...
        plt.figure(figsize=(20, 8))
        plt.errorbar(alpha_values, mean_loss[:, 0], yerr=std_loss[:, 0], color='m', label='Dead neurons', elinewidth=0.8)
        plt.scatter(alpha_values, mean_loss[:, 0])
        plt.plot(alpha_values, [experts_diff_loss[0]] * len(runs), '--r', label='BL Dead neurons')
        ...
        plt.figure(figsize=(20, 8))
        plt.errorbar(alpha_values, mean_loss[:, 1], yerr=std_loss[:, 1], color='red', label='Live neurons', elinewidth=0.8)
        plt.scatter(alpha_values, mean_loss[:, 1])
        plt.plot(alpha_values, [experts_diff_loss[1]] * len(runs), '--m', label='BL Live neurons')
        plt.xlabel('Alpha value')
        plt.ylabel('Loss')
        plt.xticks(alpha_values)
        plt.ylim([0, 20])
        ...
        plt.figure(figsize=(20, 8))
        plt.errorbar(alpha_values, mean_loss_rel[:, 0], yerr=std_loss[:, 1], color='m', label='Dead neurons', elinewidth=0.8)
        plt.scatter(alpha_values, mean_loss[:, 0])
        plt.xlabel('Alpha value')
        plt.ylabel('Relative Loss')
        plt.xticks(alpha_values)
