...
if __name__=='__main__':
    ...
    if mode:
        ...
        plt.errorbar(runs, mean_loss[:, 0], yerr=std_loss[:, 0], color='b', capsize=7, label='Dead neurons', elinewidth=0.8)
        plt.scatter(runs, mean_loss[:, 0])
        plt.plot(runs, [experts_diff_loss[0]] * len(runs), '--k', label='BL Dead neurons')
        ...
        plt.figure(figsize=(20, 8))
        plt.errorbar(runs, mean_loss[:, 1], yerr=std_loss[:, 1], color='blue', capsize=7, label='Live neurons', elinewidth=0.8)
        plt.scatter(runs, mean_loss[:, 1])
        plt.plot(runs, [experts_diff_loss[1]] * len(runs), '--k', label='BL Live neurons')
        plt.xlabel('Size of training data')
        plt.ylabel('Loss')
        plt.xticks(np.arange(0, 2000, 200))
        plt.ylim([0, 20])
        ...
        plt.figure(figsize=(20, 8))
        plt.errorbar(runs, mean_loss_rel[:, 0], yerr=std_loss[:, 1], color='b', capsize=7, label='Dead neurons', elinewidth=0.8)
        plt.scatter(runs, mean_loss[:, 0])
        plt.xlabel('Size of training data')
        ...
        plt.figure(figsize=(20, 8))
        plt.errorbar(alpha_values, mean_loss[:, 0], yerr=std_loss[:, 0], color='b', capsize=7, label='Dead neurons', elinewidth=0.8)
        plt.scatter(alpha_values, mean_loss[:, 0])
        plt.plot(alpha_values, [experts_diff_loss[0]] * len(runs), '--k', label='BL Dead neurons')
        plt.xlabel('Alpha value')
        plt.ylabel('Loss')
        plt.xticks(alpha_values)
        plt.ylim([0, 40])
        plt.grid()
        plt.title('Loss over alpha value')
        plt.legend()
        plt.savefig(report_results + 'dead_alpha_loss.png', dpi=200)

        plt.figure(figsize=(20, 8))
        plt.errorbar(alpha_values, mean_loss[:, 1], yerr=std_loss[:, 1], color='blue', capsize=7, label='Live neurons', elinewidth=0.8)
        plt.scatter(alpha_values, mean_loss[:, 1])
        plt.plot(alpha_values, [experts_diff_loss[1]] * len(runs), '--k', label='BL Live neurons')
        plt.xlabel('Alpha value')
        plt.ylabel('Loss')
        plt.xticks(alpha_values)
        plt.ylim([0, 15])
        ...
        plt.title('Loss over alpha value')
        plt.legend()
        plt.savefig(report_results + 'live_alpha_loss.png', dpi=200)

        plt.figure(figsize=(20, 8))
        plt.errorbar(alpha_values, mean_loss_rel[:, 0], yerr=std_loss[:, 1], color='b', capsize=7, label='Dead neurons', elinewidth=0.8)
        plt.scatter(alpha_values, mean_loss[:, 0])
        plt.xlabel('Alpha value')
        plt.ylabel('Relative Loss')
        plt.xticks(alpha_values)
        ...
        plt.title('Loss over alpha value')
        plt.legend()
        plt.savefig(report_results + 'dead_alpha_rel_loss.png', dpi=200)
        ...
        plt.title('Loss over alpha value')
        plt.legend()
        plt.savefig(report_results + 'live_alpha_rel_loss.png', dpi=200)
