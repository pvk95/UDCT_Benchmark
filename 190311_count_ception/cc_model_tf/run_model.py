...
save_folder = '//scratch-second/karthikp/Apr_10/'

base_args = ["python","cc_model_tf/cc_main.py","-train_model","True","-lr","0.01","-filename_data","dataset_32_1.h5","-epochs","12000"]
...
for sim in range(n_sim):
    ...
    for i in range(n_tr):
        ...
        add = ["-folder",path_folder,"-sz_tr",str(sizes_tr[i])]
