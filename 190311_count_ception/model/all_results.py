...
if __name__ == '__main__':
    ...
    plt.errorbar(sz_tr, data_loss, yerr=data_loss_std, color='b', capsize=7, label='Test loss', elinewidth=0.8)
    plt.scatter(sz_tr, data_loss)
    plt.plot(sz_tr, [experts_diff_loss[obj]] * len(sz_tr), '--k', label='Disagreement b/w experts')
    ...
    plt.figure(figsize=(20, 8), dpi=200)
    plt.errorbar(sz_tr, data_loss, yerr=data_loss_std, color='b', capsize=7, label='Test Loss')
    plt.errorbar(sz_tr, data_loss_train, yerr=data_loss_train_std, color='red', capsize=7, label='Training Loss')
    plt.plot(sz_tr, [experts_diff_loss[obj]] * len(sz_tr), '--k', label='Disagreement b/w experts')
    plt.scatter(sz_tr, data_loss)
